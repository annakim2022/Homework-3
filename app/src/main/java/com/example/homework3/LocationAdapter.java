...
public class LocationAdapter extends RecyclerView.Adapter<LocationAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull LocationAdapter.ViewHolder holder, int position) {
        ...
        holder.textView_location.setText(location.getLocation());
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            textView_location = itemView.findViewById(R.id.textView_locations);
            textView_dimension = itemView.findViewById(R.id.textView_dimensions);
            textView_type = itemView.findViewById(R.id.textView_types);
        }
    }
}